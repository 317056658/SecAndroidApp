...
import com.kkkcut.www.myapplicationkukai.dao.JPushMsgDaoManager;
...
import static com.kkkcut.www.myapplicationkukai.activity.MainActivity.msg;

public class PushMsgActivity extends AppCompatActivity implements SwipeRefreshLayout.OnRefreshListener {
    ...
    Handler hander=new Handler(){
        ...
        public void handleMessage(Message msg) {
            ...
            //更新数据
            adapter=new MsgAdapter(PushMsgActivity.this,list);
       ...
       swipeRefresh=(SwipeRefreshLayout)findViewById(R.id.swipeRefresh);
        ...
        lv.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            public void onItemClick(AdapterView<?> adapterView, View view, int position, long l) {
                Toast.makeText(PushMsgActivity.this, list.get(position).getTime(), Toast.LENGTH_SHORT).show();
                JPushMsgDaoManager sql=new JPushMsgDaoManager(PushMsgActivity.this);
                sql.updateState(list.get(position).getId());
                //代表文本网络显示
                if(list.get(position).getType()==1)
                {
                    TempInfo.jump=true;
                    Intent intent=new Intent(PushMsgActivity.this, TextActivity.class);
    ...
    protected void onStart() {
        super.onStart();
        JPushMsgDaoManager sql = new JPushMsgDaoManager(this);
        ...
        switch (item.getItemId()) {
            case 0:
                ...
                builder.setPositiveButton("确定", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        JPushMsgDaoManager sqlDelete = new JPushMsgDaoManager(PushMsgActivity.this);
                        //根据时间删除
            ...
            case 1:
                ...
                builder1.setPositiveButton("确定", new DialogInterface.OnClickListener() {
                    @Override
                    public void onClick(DialogInterface dialog, int which) {
                        JPushMsgDaoManager sqlDelete1 = new JPushMsgDaoManager(PushMsgActivity.this);
