    ...
    public void onClick(View view) {
        ...
        switch (view.getId()) {
            ...
            case R.id.btn_cut_history:  //跳转切割记录
                KeyInfoBoxroomActivity.startItselfActivity(this,
                                                                    languageMap,
                        KeyInfoBoxroomActivity.FLAG_CUT_HISTORY);
                break;
            ...
            case R.id.btn_favorite:  //收藏夹
                KeyInfoBoxroomActivity.startItselfActivity(this,languageMap,
                        KeyInfoBoxroomActivity.FLAG_FAVORITE);
                break;
