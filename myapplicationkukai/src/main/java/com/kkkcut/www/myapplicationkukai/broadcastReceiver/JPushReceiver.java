package com.kkkcut.www.myapplicationkukai.broadcastReceiver;
...
import com.kkkcut.www.myapplicationkukai.activity.PushMsgActivity;
import com.kkkcut.www.myapplicationkukai.activity.MainActivity;
import com.kkkcut.www.myapplicationkukai.R;
import com.kkkcut.www.myapplicationkukai.activity.TextActivity;
...
public class JPushReceiver extends BroadcastReceiver {
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        if(title!=null&&introduce!=null){
            ...
            JPushMsgDaoManager sql=new JPushMsgDaoManager(context);
            sql.insertObject(id,title,introduce,0,TempInfo.key,TempInfo.textMessage1,str);
            title=null;
            introduce=null;
            if(TempInfo.start){
                JPushMsgDaoManager sqll=new JPushMsgDaoManager(context);
                PushMsgActivity.list  =sqll.queryAllsort();
                PushMsgActivity.adapter=new MsgAdapter(context, PushMsgActivity.list);
                PushMsgActivity.lv.setAdapter(PushMsgActivity.adapter);
