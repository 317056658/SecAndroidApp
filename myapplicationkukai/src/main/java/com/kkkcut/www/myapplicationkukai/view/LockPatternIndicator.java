package com.kkkcut.www.myapplicationkukai.view;
...
import com.kkkcut.www.myapplicationkukai.utils.LockPatternUtil;
...
public class LockPatternIndicator extends View {
    ...
    public LockPatternIndicator(Context context, @Nullable AttributeSet attrs) {
        this(context,attrs,0);
    }

    public LockPatternIndicator(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
