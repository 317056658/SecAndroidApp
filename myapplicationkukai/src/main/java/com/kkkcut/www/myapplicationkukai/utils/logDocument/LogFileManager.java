package com.kkkcut.www.myapplicationkukai.utils.logDocument;
...
public class LogFileManager {
    private static final int LOG_FILES_MAX_NUM = 2; //文件最多有3个
    private static final int LOG_FILE_MAX_SIZE = 300 * 300; //文件最大0.3MB

    private static final SimpleDateFormat LOG_FILE_DATE_FORMAT = new SimpleDateFormat("yyyy-MM-dd-HH-mm");
    ...
    private File getNewLogFile() {
        ...
        Log.d("文件大小是？", "getNewLogFile: "+lastLogFile.length());
