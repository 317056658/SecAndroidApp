package com.kkkcut.www.booleanteeth;
...
import com.kkkcut.www.booleanteeth.service.ReceiveSocketService;
import com.kkkcut.www.booleanteeth.service.SendSocketService;
...
public class BltSocketAcivity extends AppCompatActivity implements View.OnClickListener {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_blt_socket_acivity);
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.go_text_btn://发送文本消息
              ...
              //  SendSocketService.sendMessage(getHexBytes(message).toString().trim());

              //  content_ly.addView(getRightTextView(getHexBytes(message).toString().trim()));
              //  if (TextUtils.isEmpty(go_edit_text.getText().toString().trim())) return;
                SendSocketService.sendMessage(message);
